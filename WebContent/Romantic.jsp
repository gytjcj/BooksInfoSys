				...
				<div class="row mt-4">
					<div class="col-sm-6 col-lg-6">
						<div class="services-list b-box hover-state p-4 mt-4 wow fadeInUp" data-wow-duration="1.5s">
							...
							<div class="mt-4">				   
								<h5 class="mb-0">独步成仙</h5>
								<p class=" mt-3">是中国旧体小说的一种，以讲述男女之间相爱为中心，通过完整的故事情节和具体的环境描写来反映爱情的心理、状态、事物等社会生活的一种文学体裁。</p>
								<a href="yanqing/独步成仙.txt">阅读</a>								
							</div>
						</div>
					</div>
					<div class="col-sm-6 col-lg-6">
						<div class="services-list b-box hover-state p-4 mt-4 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay=".2s">
							...
							<div class="mt-4">
								<h5 class="mb-0">海贼之国王之上</h5>
								<p class=" mt-3">称狭邪小说或才子佳人小说。通过完整的故事情节和具体的环境描写来反映爱情的心理、状态、事物等社会生活的一种文学体裁。</p>
								<a href="yanqing/海贼之国王之上.txt">阅读</a>
							</div>
						</div>
					</div>
					<div class="col-sm-6 col-lg-6">
						<div class="services-list b-box hover-state p-4 mt-4 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay=".3s">
							...
							<div class="mt-4">
								<h5 class="mb-0">山村小神医</h5>
								<p class=" mt-3">是中国旧体小说的一种，又称狭邪小说或才子佳人小说。以讲述男女之间相爱为中心，通过完整的故事情节和具体的环境描写来反映爱情的心理、状态、事物等社会生活的一种文学体裁。</p>
								<a href="yanqing/山村小神医.txt">阅读</a>
							</div>
						</div>
					</div>						
					</div>
