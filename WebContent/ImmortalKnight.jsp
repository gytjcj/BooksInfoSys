					...
					<div class="col-sm-6 col-lg-6">
						<div class="services-list b-box hover-state p-4 mt-4 wow fadeInUp" data-wow-duration="1.5s">
							<div class="services-list-icon">
								...
								<span>01</span>
								<span><img src="assets/images/xx1.jpg"></span>
							</div>
							<div class="mt-4">				   
								<h5 class="mb-0">从灵气复苏到末法时代</h5>
								<p class=" mt-3">是网络作家叶恨水创作的仙侠类网络小说修仙觅长生，热血任逍遥，踏莲曳波涤剑骨，凭虚御风塑圣魂！</p>
								<a href="xianxia/从灵气复苏到末法时代.txt">阅读</a>								
							</div>
						</div>
					</div>
					<div class="col-sm-6 col-lg-6">
						<div class="services-list b-box hover-state p-4 mt-4 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay=".2s">
							...
							<div class="mt-4">
								<h5 class="mb-0">千机殿</h5>
								<p class=" mt-3">是缘分0创作的仙侠类网络小说</p>
								<a href="xianxia/千机殿.txt">阅读</a>
							</div>
						</div>
					</div>
					<div class="col-sm-6 col-lg-6">
						<div class="services-list b-box hover-state p-4 mt-4 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay=".3s">
							<div class="services-list-icon">
								<i class="lni-video"></i>
								<span>03</span>
								<span><img src="assets/images/xx2.jpg"></span>
							</div>
							<div class="mt-4">
								<h5 class="mb-0">师叔万万岁</h5>
								<p class=" mt-3"> 作者东南俗人所著的一部修真小说。热血任逍遥，踏莲曳波涤剑骨，凭虚御风塑圣魂！</p>
								<a href="xianxia/师叔万万岁.txt">阅读</a>
							</div>
						</div>
					</div>						
					</div>
